...
export type MarketplacePermission = 'study:read' | 'study:signals' | 'content:read' | 'content:patch-own' | 'media:create' | 'network:fetch' | 'secrets:device' | 'config:sync' | 'ui:settings' | 'ui:review' | 'ui:page'
...
const permissionSet = new Set<MarketplacePermission>(['study:read', 'study:signals', 'content:read', 'content:patch-own', 'media:create', 'network:fetch', 'secrets:device', 'config:sync', 'ui:settings', 'ui:review', 'ui:page'])
