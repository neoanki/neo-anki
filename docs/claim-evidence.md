...
Status below is aligned with the July 19 comprehensive audit, its remediation ledger, and the July 21 completed internal-extension extraction audit. Neo Anki 0.3.1 clarifies extension names and fixes module-worker loading but does not broaden the compatibility, durability, sync, mobile, or learning-effectiveness claims below.
