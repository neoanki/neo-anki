...
export const PlansPage = () => {
  ...
  return <div className="page plans-page">
    <header className="page-header"><div><p className="eyebrow">Workspace tools</p><h1>Plans & sharing</h1><p className="page-intro">Use installed extensions to manage goals, saved searches, and learning packs.</p></div></header>
