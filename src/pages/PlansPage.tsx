...
export const PlansPage = () => {
  ...
  return <div className="page plans-page">
    ...
    {selected && Panel ? <Panel extensionId={selected.id} data={data} plan={plan} runCommand={runExtensionCommand}/> : <div className="empty-state"><h2>No workspace extensions</h2><p>Install an extension that contributes a workspace panel.</p></div>}
  </div>
}
