      ...
      <section ref={dialogRef} tabIndex={-1} className="settings-panel" role="dialog" aria-modal="true" aria-labelledby="settings-title">
        ...
        <div className="setting-block">
          ...
          <div className="button-row">
            ...
            <input ref={fileRef} className="visually-hidden" type="file" accept=".json" aria-label="Choose Neo Anki JSON backup to import" onChange={(event) => void importFile(event.target.files?.[0])} />
          </div>
